...
def main1(input_file: str=None, output_dir: str = "results", gpu: int = 2, embeddings_file: str = None, labels_file: str = None, organism_id: str = None, substrates_inchis: list = None, binary_threshold=0.5, annotation_threshold=0.5):
...
if __name__ == "__main__":
    ...
    main1(args.organism_id, args.substrates_inchis, args.input_dir, args.output_dir, args.gpu, args.embeddings_file, args.labels_file, args.binary_threshold) 